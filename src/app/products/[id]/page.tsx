      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 text-[14px] font-semibold text-slate-700 hover:text-[#0066ff] transition-all bg-white px-4 py-2 rounded-xl border border-slate-200 shadow-sm hover:shadow-md cursor-pointer"
          >
            <ArrowLeft className="w-4 h-4" />
            Back to Card
          </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 bg-white rounded-3xl border border-slate-100 p-6 sm:p-8 md:p-10 shadow-[0_4px_30px_rgba(0,0,0,0.02)] mb-12">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between h-full py-2">
            <div>
              ...
              {/* Tagline */}
              <p className="text-[15px] font-semibold text-[#0066ff] mb-6">
                {product.tagline}
              </p>
              ...
              <div className="mb-6 pb-6 border-b border-slate-100">
                <div className="flex items-baseline gap-4 mb-1">
                  <span className="text-3xl sm:text-4xl font-extrabold text-[#16a34a] border-b-4 border-[#16a34a]/30 pb-1 leading-none">
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center gap-4">
                  ...
                  {quantity > 1 && (
                    <div className="text-xs font-bold text-[#16a34a] bg-[#f0fdf4] border border-[#bbf7d0] px-3.5 py-2 rounded-full">
                      Total: ₹{totalPrice.toLocaleString("en-IN")} (Excl. GST)
                    </div>
                  )}
                </div>
              </div>
            ...
            <button
              ...
              className="w-full h-14 bg-[#16a34a] hover:bg-[#15803d] text-white font-extrabold text-[15px] tracking-wider rounded-xl transition-all duration-200 active:scale-[0.98] flex items-center justify-center gap-2.5 cursor-pointer shadow-lg shadow-emerald-600/20"
            >
