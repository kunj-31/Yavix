...
export const metadata: Metadata = {
  title: {
    absolute: `Solar Panel Cleaning Services in Ahmedabad | ${BRAND_NAME}`,
  },
  description:
    "Solar panel cleaning services in Ahmedabad — residential, commercial, industrial, rooftop, solar farm and AMC. Best professional solar cleaning by Yavix Energy. Book free inspection.",
  alternates: { canonical: `${SITE_URL}/services` },
  openGraph: {
    title: `Solar Panel Cleaning Services in Ahmedabad | ${BRAND_NAME}`,
    description:
      "Best solar panel cleaning in Ahmedabad for homes, offices, hospitals, factories and solar farms.",
    ...
    <main className="min-h-screen bg-slate-50 pt-28 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-4xl sm:text-5xl font-extrabold text-primary-900 mb-4">
          Solar Panel Cleaning Services in <span className="gradient-text">Ahmedabad</span>
        </h1>
        <p className="text-gray-600 max-w-3xl mb-12 text-lg">
          Looking for the best solar panel cleaning in Ahmedabad? Yavix Energy offers end-to-end
          solar panel cleaning for homes, businesses and every commercial property type. Choose your
          service and book via WhatsApp.
        </p>
