...
import { Phone, MessageCircle, MapPin, Clock, Send, Zap, Mail } from "lucide-react";
    ...
    <section className="section-pad bg-white" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          {/* Info Side */}
          <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="flex flex-col gap-8">
            ...
            <div className="p-8 rounded-3xl bg-gradient-to-br from-primary-600 to-primary-900 text-white shadow-xl shadow-primary-500/30 selection:bg-yellow-400 selection:text-primary-900">
              ...
              <p className="text-primary-200 text-[14px] mb-8 font-medium">Get in touch with our experts.</p>

              <div className="flex flex-col gap-5">
                <div className="flex gap-4 items-start text-[14.5px] text-primary-100">
                  <div className="w-10 h-10 shrink-0 bg-white/10 rounded-full flex items-center justify-center text-white"><MapPin className="w-5 h-5" /></div>
                  <span className="mt-2 leading-relaxed">36, Bhagyoday Society, Thakkarbapanagar Road,<br />Ahmedabad, Gujarat 382350</span>
                </div>
                <div className="flex gap-4 items-center text-[14.5px] text-primary-100">
                  <div className="w-10 h-10 shrink-0 bg-white/10 rounded-full flex items-center justify-center text-white"><Phone className="w-5 h-5" /></div>
                  <span className="font-semibold">+91 92743 71058</span>
                </div>
                <div className="flex gap-4 items-center text-[14.5px] text-primary-100">
                  <div className="w-10 h-10 shrink-0 bg-white/10 rounded-full flex items-center justify-center text-white"><Mail className="w-5 h-5" /></div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              ...
              <a href={`https://wa.me/${WA_NUMBER}?text=${encodeURIComponent("Hello Yavix Solar Cleaning! I'd like to book a service.")}`}
                ...
                <img src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg" alt="WhatsApp" className="w-6 h-6" /> WhatsApp
              </a>
              <a href="mailto:yavixenergy@gmail.com"
              ...
              <a href="https://maps.google.com/?q=36+Bhagyoday+Society+Thakkarbapanagar+Road+Ahmedabad+Gujarat+382350"
                target="_blank" rel="noopener noreferrer"
          ...
          <motion.div initial={{ opacity: 0, x: 24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
            <form onSubmit={handleSubmit} className="bg-white rounded-3xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 flex flex-col gap-5 h-full">
              <h3 className="font-extrabold text-2xl text-primary-900 mb-2">Book a Cleaning</h3>
              ...
              <div>
                <label className="block text-[13px] font-bold text-gray-700 mb-1.5">Installation Address *</label>
              ...
              <div>
                <label className="block text-[13px] font-bold text-gray-700 mb-1.5">Solar Panel Size</label>
              ...
              <button type="submit"
                ...
                {sent ? <><Zap className="w-5 h-5" /> Opening WhatsApp…</> : <><Send className="w-5 h-5" /> Send Request via WhatsApp</>}
              </button>
            </form>
          </motion.div>
        </div>
